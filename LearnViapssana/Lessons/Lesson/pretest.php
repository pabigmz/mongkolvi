...
if ($pretestComplete && $pretestComplete['pre_completed'] == 1) {
    header('Location: ./learn.php?id='.$lessonId);
    exit(); // ต้องใส่ exit() เพื่อหยุดการทำงานหลัง redirect
}

// ดึงข้อมูลข้อสอบจากฐานข้อมูล
$sql = "SELECT quiz_id, numbers, question, choice_a, choice_b, choice_c, choice_d FROM quizzes WHERE lesson_id = $lessonId";
    ...
    <main>
        <div class="container">
            ...
            <div class="content-exam" style="display: none;">
                ...
                <form id="quizForm" action="check_pretest.php?id=<?php echo $lessonId; ?>" method="post">
