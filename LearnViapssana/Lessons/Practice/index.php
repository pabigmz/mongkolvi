...
$pracId = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
...
try {
    ...
    $stmt->execute(['user_id' => $userId, 'practice_id' => $pracId]);
    ...
    if (!$progress) {
        $stmt = $conn->prepare("
            ...
            VALUES (:user_id, :practice_id, FALSE, FALSE, 0)
        ");
        $stmt->execute(['user_id' => $userId, 'practice_id' => $pracId]);
    ...
    <main>
        <div class="container">
            ...
            <div class="lesson-content">
                <h1><?php echo htmlspecialchars($practices['practice_title']); ?></h1>
                <div class="btn">
                    <a href="./pretest.php?id=<?php echo $pracId; ?>">เริ่มเรียน</a>
                </div>
            </div>
            <div class="tab_box">
            ...
            <div class="content_box">
                <div class="content active">
                    ...
                    <ul>
                        <li>
                            <?php echo htmlspecialchars($practices['practice_title']); ?>
                        </li>
                    </ul>
                </div>
                <div class="content">
                    ...
                    <div class="pretest_box">
                        ...
                        <div class="result">
                            ...
                            <?php } else { ?>
                                <div class="score">
                                    <h4>คะแนนของคุณ</h4>
                                    <p><?php echo $progress['score_pre']; ?>/5</p>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="posttest_box">
                        ...
                        <div class="result">
                            ...
                            <?php } else { ?>
                                <div class="score">
                                    <h4>คะแนนของคุณ</h4>
                                    <p><?php echo $progress['score_post']; ?>/5</p>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
