...
$sql = "SELECT id, number, quiz_title, choice_a, choice_b, choice_c, choice_d, choice_e FROM quizzes_practice WHERE practice_id = :practice_id";
...
<body>
    <header>
        <div class="return">
            <a href="./practice.php?id= <?php echo $pracId; ?>"><i class='bx bx-left-arrow-alt'></i> กลับ</a>
        </div>
    </header>
    ...
    <main>
        <div class="container">
            ...
            <div class="content-exam" style="display: none;">
                ...
                <form id="quizForm" action="check_posttest.php?id=<?php echo $pracId; ?>" method="post">
