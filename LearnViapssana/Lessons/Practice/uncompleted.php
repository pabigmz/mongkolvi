...
$stmt = $conn->prepare("SELECT score_post FROM user_practice_progress WHERE user_id = :user_id AND practice_id = :pracId");
$stmt->execute(['user_id' => $userId,'pracId' => $pracId]);

$score = $stmt->fetch(PDO::FETCH_ASSOC);

$percentScore = $score['score_post'] * 20;
...
<body>
    <main>
        <div class="container">
            ...
            <div class="btn">
                <a href="./posttest.php?id=<?php echo $pracId; ?>"><i class='bx bx-redo'></i>กลับไปสอบอีกครั้ง</a>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        let progressStartValue = 0,
            progressEndValue = <?php echo $percentScore; ?>, // เป้าหมาย %
            speed = 100; // ความเร็ว
